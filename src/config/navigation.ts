export const navigationGroups = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Load Upload", path: "/v2/dispatch/load-upload", icon: "Upload" },
      { label: "Category Rules", path: "/v2/dispatch/category-rules", icon: "ListChecks" },
      { label: "Load Validation", path: "/v2/dispatch/load-validation", icon: "ShieldCheck" },
